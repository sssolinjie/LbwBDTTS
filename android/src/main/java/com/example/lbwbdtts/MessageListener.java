...
import com.example.lbwbdtts.MainHandlerConstant;

import org.json.JSONException;
import com.example.lbwbdtts.LbwbdttsPlugin;
...
public class MessageListener implements SpeechSynthesizerListener{
    ...
    private  final LbwbdttsPlugin channel;
    public MessageListener(LbwbdttsPlugin listener) {
        this.channel = listener;
    }

    public void dart(String state , String id){
        channel.playTTsEnd(state, id);
    }
    /**
     * 播放开始，每句播放开始都会回调
     *
...
//        Log.i(TAG, "合成进度回调, progress：" + progress + ";序列号:" + utteranceId);
    ...
    public void onSpeechProgressChanged(String utteranceId, int progress) {
       ...
       try {
           dart("ing", String.valueOf(progress));
